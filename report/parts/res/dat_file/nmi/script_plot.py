...
if __name__ == "__main__":
    ...
    while line != "":
        ...
        lex_simple.append(float(tmp[3]))
        lex_simple_add.append(float(tmp[4]))
    ...
    lines += ax.plot(nb_kw, lex_simple,colors[0], label='Simple pretrain', linewidth=2)
    ...
    fig.legend(lines[:2], ['Simple pretrain', 'Simple pretrain, Additional Class'],
