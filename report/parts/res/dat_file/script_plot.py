...
if __name__ == "__main__":
    ...
    while line != "":
        ...
        lex_non_discr.append(float(tmp[3]))
        lex_non_discr_add.append(float(tmp[4]))
    ...
    lines += ax.plot(nb_kw, lex_non_discr,colors[2], label='Non Discriminating', linewidth=2)
    lines += ax.plot(nb_kw, lex_non_discr_add,colors[3], label='Non Discriminating, Add class', linewidth=2)
    ...
    fig.legend(lines[2:4], ['Non Discriminating', 'Non Discriminating, Add Class'],
