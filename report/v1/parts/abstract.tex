\begin{abstract}
  ...
  knowledge. Thematic clustering is the set of lexical constraints baising the text 
  clustering towards to different themes. These lexical constraints are represented
  by a set of keywords given by the user. Background knowledge are the set of 
  pairwise constraints given by the user. 
